...
exec sp_nuevoUsuario 'Alma Marcela', 'Gozo', 'eduardovarela139@gmail.com', 'Administrador';
exec sp_nuevoUsuario 'Elpa', 'Nochon', '', 'Administrador';
exec sp_nuevoUsuario 'Turcaen', 'Llama', '', 'Administrador';
...
select * from Producto.Detalle_Telefono;
